...
extern "C" { 
    ...
    extern int lg_ngx_network_create_session(ngx_http_request_t *r, char *key, char **value);
    extern int lg_ngx_network_get_session(ngx_http_request_t *r, char *key, char **value);
