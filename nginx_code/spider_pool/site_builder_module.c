...
static ngx_command_t  ngx_site_builder_module_commands[] = {
	...
	NULL },
    {
	ngx_string("site_builder_module_link_external_url_file"),
	NGX_HTTP_LOC_CONF | NGX_CONF_TAKE1,
	ngx_conf_set_str_slot,
	NGX_HTTP_LOC_CONF_OFFSET,
	offsetof(site_builder_loc_conf_t, link_external_url_file),
	NULL },
    {
	ngx_string("site_builder_module_link_external_keyword_file"),
	NGX_HTTP_LOC_CONF | NGX_CONF_TAKE1,
	ngx_conf_set_str_slot,
	NGX_HTTP_LOC_CONF_OFFSET,
	offsetof(site_builder_loc_conf_t, link_external_keyword_file),
	NULL },
    {
