...
void site_builder_element_init(site_builder_element_head_t *p, ngx_pool_t *pool)
{
    p->head = RB_ROOT;
    p->pool = pool;
    p->total = 0;
...
site_builder_element_t *site_builder_element_key_find(site_builder_element_head_t *p, const char *key)
{

    return (site_builder_element_t *)lg_tree_element_key_find(&p->head, key);
}

site_builder_element_t *site_builder_element_index_find(site_builder_element_head_t *p, int index)
{

    return (site_builder_element_t *)lg_tree_element_index_find(&p->head, index);
}

site_builder_element_t *site_builder_element_index_rand(site_builder_element_head_t *p)
{
...
site_builder_element_t *site_builder_element_key_add(site_builder_element_head_t *p,
	...
	const char *buffer, int buffer_size)
{
    ...
    site_builder_element_t *element = ngx_pcalloc(p->pool, sizeof(site_builder_element_t));
    ...
    element->tree.key = (char *)element->key;
    memcpy((char *)element->key, key, key_size);
    ((char *)element->key)[key_size] = 0;
...
site_builder_element_t *site_builder_element_key_add_r(site_builder_element_head_t *p,
	const char *key, int key_size,
	const char *buffer, int buffer_size)
{
...
site_builder_element_t *site_builder_element_index_add(site_builder_element_head_t *p,
	const char *buffer, int buffer_size)
{
...
site_builder_element_t *site_builder_element_index_add_r(site_builder_element_head_t *p,
	const char *buffer, int buffer_size)
{
...
int site_builder_element_load_file(const char *file_path, site_builder_element_head_t *p, ngx_pool_t *pool)
{
...
int site_builder_element_load_link_external_file(const char *file_path, site_builder_element_head_t *p, ngx_pool_t *pool)
{
