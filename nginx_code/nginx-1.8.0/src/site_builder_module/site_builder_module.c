...
static ngx_command_t  ngx_site_builder_module_commands[] = {
	...
	NULL },
    {
	ngx_string("site_builder_module_template_id"),
	NGX_HTTP_LOC_CONF | NGX_CONF_TAKE1,
	ngx_conf_set_str_slot,
	NGX_HTTP_LOC_CONF_OFFSET,
	offsetof(site_builder_loc_conf_t, template_id),
	NULL },
    {
	ngx_string("site_builder_module_keyword_dict"),
	NGX_HTTP_LOC_CONF | NGX_CONF_TAKE1,
	ngx_conf_set_str_slot,
	NGX_HTTP_LOC_CONF_OFFSET,
	offsetof(site_builder_loc_conf_t, keyword_dict),
	NULL },
    {
	ngx_string("site_builder_module_content_dict"),
	NGX_HTTP_LOC_CONF | NGX_CONF_TAKE1,
	ngx_conf_set_str_slot,
	NGX_HTTP_LOC_CONF_OFFSET,
	offsetof(site_builder_loc_conf_t, content_dict),
	NULL },
    {
	ngx_string("site_builder_module_link_external_dict"),
	NGX_HTTP_LOC_CONF | NGX_CONF_TAKE1,
	ngx_conf_set_str_slot,
	NGX_HTTP_LOC_CONF_OFFSET,
	offsetof(site_builder_loc_conf_t, link_external_dict),
	NULL },
