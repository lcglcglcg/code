...
static ngx_command_t  ngx_site_builder_module_commands[] = {
	...
	NULL },
    {
	ngx_string("site_builder_module_link_subdomain_file"),
	NGX_HTTP_LOC_CONF | NGX_CONF_TAKE1,
	ngx_conf_set_str_slot,
	NGX_HTTP_LOC_CONF_OFFSET,
	offsetof(site_builder_loc_conf_t, link_subdomain_file),
	NULL },
    {
	ngx_string("site_builder_module_mate_file"),
	NGX_HTTP_LOC_CONF | NGX_CONF_TAKE1,
	ngx_conf_set_str_slot,
	NGX_HTTP_LOC_CONF_OFFSET,
	offsetof(site_builder_loc_conf_t, mate_file),
	NULL },
    {
	ngx_string("site_builder_module_link_group0"),
	NGX_HTTP_LOC_CONF | NGX_CONF_TAKE1,
	ngx_conf_set_str_slot,
	NGX_HTTP_LOC_CONF_OFFSET,
	offsetof(site_builder_loc_conf_t, link_group[0]),
	NULL },
    {
	ngx_string("site_builder_module_link_group1"),
	NGX_HTTP_LOC_CONF | NGX_CONF_TAKE1,
	ngx_conf_set_str_slot,
	NGX_HTTP_LOC_CONF_OFFSET,
	offsetof(site_builder_loc_conf_t, link_group[1]),
	NULL },
    {
	ngx_string("site_builder_module_link_group2"),
	NGX_HTTP_LOC_CONF | NGX_CONF_TAKE1,
	ngx_conf_set_str_slot,
	NGX_HTTP_LOC_CONF_OFFSET,
	offsetof(site_builder_loc_conf_t, link_group[2]),
	NULL },
    {
	ngx_string("site_builder_module_link_group3"),
	NGX_HTTP_LOC_CONF | NGX_CONF_TAKE1,
	ngx_conf_set_str_slot,
	NGX_HTTP_LOC_CONF_OFFSET,
	offsetof(site_builder_loc_conf_t, link_group[3]),
	NULL },
    {
	ngx_string("site_builder_module_link_group4"),
	NGX_HTTP_LOC_CONF | NGX_CONF_TAKE1,
	ngx_conf_set_str_slot,
	NGX_HTTP_LOC_CONF_OFFSET,
	offsetof(site_builder_loc_conf_t, link_group[4]),
	NULL },
    {
	ngx_string("site_builder_module_link_group5"),
	NGX_HTTP_LOC_CONF | NGX_CONF_TAKE1,
	ngx_conf_set_str_slot,
	NGX_HTTP_LOC_CONF_OFFSET,
	offsetof(site_builder_loc_conf_t, link_group[5]),
	NULL },
    {
	ngx_string("site_builder_module_link_group6"),
	NGX_HTTP_LOC_CONF | NGX_CONF_TAKE1,
	ngx_conf_set_str_slot,
	NGX_HTTP_LOC_CONF_OFFSET,
	offsetof(site_builder_loc_conf_t, link_group[6]),
	NULL },
    {
	ngx_string("site_builder_module_link_group7"),
	NGX_HTTP_LOC_CONF | NGX_CONF_TAKE1,
	ngx_conf_set_str_slot,
	NGX_HTTP_LOC_CONF_OFFSET,
	offsetof(site_builder_loc_conf_t, link_group[7]),
	NULL },
    {
	ngx_string("site_builder_module_link_group8"),
	NGX_HTTP_LOC_CONF | NGX_CONF_TAKE1,
	ngx_conf_set_str_slot,
	NGX_HTTP_LOC_CONF_OFFSET,
	offsetof(site_builder_loc_conf_t, link_group[8]),
	NULL },
    {
	ngx_string("site_builder_module_link_group9"),
	NGX_HTTP_LOC_CONF | NGX_CONF_TAKE1,
	ngx_conf_set_str_slot,
	NGX_HTTP_LOC_CONF_OFFSET,
	offsetof(site_builder_loc_conf_t, link_group[9]),
	NULL },
...
static ngx_int_t ngx_site_builder_module_worker_init(ngx_cycle_t *cycle)
{
    ...
    return site_builder_global_init(cycle);
    return NGX_OK;
}
