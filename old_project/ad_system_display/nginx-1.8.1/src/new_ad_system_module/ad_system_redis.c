...
static char *REDIS_HOST = "127.0.0.1";
...
int ad_system_redis_add_var_code(char *session_id, char *value)
{
    if (!session_id || !value)
	return -1;
...
int ad_system_redis_get_var_code(char *session_id, char *value)
{
...
int ad_system_redis_set_login_session(char *session_id, char *value)
{
    if (!session_id || !value)
	return -1;
...
int ad_system_redis_get_login_session(char *session_id, char *value)
{
...
int ad_system_redis_del_login_session(char *session_id)
{
    if (!session_id)
	return -1;
...
int ad_system_redis_add_delivery_center(char *key, char *account_id)
{
...
int ad_system_redis_get_delivery_center(char *key, char *account_id)
{
...
int ad_system_redis_get_account_name(char *account_id, char *account_name)
{
...
int ad_system_redis_get_img(char *img_id, char *img_name, char *img_size, char *img_buffer_size, char *img_path)
{
...
int ad_system_redis_get_manager_center(char *key)
{
