...
int lg_rbtree_insert_number(lg_rbtree_head *head, lg_rbtree_node *new_node)
{
	...
	if (new_node->number < parent->number)
	    node = &(*node)->rb_left;
	else if (new_node->number > parent->number)
	    node = &(*node)->rb_right;
	else
	    return -1;
    }

    lg_rbtree_link_node(new_node, parent, node);
    lg_rbtree_insert_color(new_node, head);
    return 0;
}

lg_rbtree_node *lg_rbtree_search_number(lg_rbtree_head *head, int number)
{
...
lg_rbtree_node *lg_rbtree_delete_number(lg_rbtree_head *head, int number)
{

    lg_rbtree_node *node = NULL;
    if (!(node = lg_rbtree_search_number(head, number)))
	return NULL;

    lg_rbtree_delete(head, node);
    return node;
}

/************STRING API**************/

int lg_rbtree_insert_string(lg_rbtree_head *head, lg_rbtree_node *new_node)
{
	...
	parent = *node;
	int retval = strcmp(new_node->string, parent->string);
...
lg_rbtree_node *lg_rbtree_search_string(lg_rbtree_head *head, char *string)
{
	...
	fprintf(stdout, "->[%s]\n", node->string);
	int retval = strcmp(string, node->string);
...
lg_rbtree_node *lg_rbtree_delete_string(lg_rbtree_head *head, char *string)
{

    lg_rbtree_node *node = NULL;
    if (!(node = lg_rbtree_search_string(head, string)))
	return NULL;
