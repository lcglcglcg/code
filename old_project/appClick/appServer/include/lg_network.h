...
extern "C" { 
    ...
    extern size_t lg_network_send(int sockfd, void *buffer, size_t buffer_size);
    extern size_t lg_network_recv(int sockfd, void *buffer, size_t buffer_size);

    typedef struct lg_network_epoll_t lg_network_epoll_t;
    typedef void(lg_network_epoll_in)(int sockfd, lg_network_epoll_t* ep);
    typedef void(lg_network_epoll_out)(int sockfd, lg_network_epoll_t* ep);
    typedef void(lg_network_epoll_err)(int sockfd, lg_network_epoll_t* ep);
    typedef void(lg_network_epoll_hup)(int sockfd, lg_network_epoll_t* ep);
    typedef void(lg_network_epoll_pri)(int sockfd, lg_network_epoll_t* ep);
    ...
    extern int lg_network_epoll_event_add(lg_network_epoll_t *ep, int sockfd,  struct sockaddr_in addr, int mask);
