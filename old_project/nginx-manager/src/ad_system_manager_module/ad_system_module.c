...
static char *ad_system_manager_module_init(ngx_conf_t *cf, ngx_command_t *cmd, void *conf);
static ngx_int_t ngx_ad_system_worker_init(ngx_cycle_t *cycle);

/* Commands */
static ngx_command_t  ad_system_manager_module_commands[] = {
    { ngx_string("ad_system_manager_module"),
	NGX_HTTP_LOC_CONF | NGX_CONF_NOARGS,
	ad_system_manager_module_init,
...
static ngx_http_module_t ad_system_manager_module_ctx = {
...
/* hook */
ngx_module_t ad_system_manager_module = {
    NGX_MODULE_V1,
    &ad_system_manager_module_ctx,	/* module context */
    ad_system_manager_module_commands,	/* module directives */
...
void ad_system_manager_module_post_handler(ngx_http_request_t *r)
{
...
static ngx_int_t ad_system_manager_module_handler(ngx_http_request_t *r)
{

    if (r->method == NGX_HTTP_POST) {

	ngx_int_t rc = ngx_http_read_client_request_body(r, ad_system_manager_module_post_handler);
...
static char *ad_system_manager_module_init(ngx_conf_t *cf, ngx_command_t *cmd, void *conf)
{
    ...
    clcf->handler = ad_system_manager_module_handler;
    return NGX_CONF_OK;
}
