#define NGX_CONFIGURE " --add-module=src/ad_system_manager_module --with-debug --error-log-path=/var/log/nginx-manager/wangmeng.log"
...
#define NGX_CONF_PATH  "conf/ad_system_manager.conf"
#endif
...
#define NGX_ERROR_LOG_PATH  "/var/log/nginx-manager/wangmeng.log"
#endif
