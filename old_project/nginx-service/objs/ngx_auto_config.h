#define NGX_CONFIGURE " --with-debug --add-module=src/ad_system_module --error-log-path=/var/log/nginx-service/wangmeng.log"
...
#define NGX_CONF_PATH  "conf/ad_system.conf"
#endif
...
#define NGX_ERROR_LOG_PATH  "/var/log/nginx-service/wangmeng.log"
#endif
