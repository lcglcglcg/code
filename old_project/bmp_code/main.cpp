...
extern "C" {
    ...
    JNIEXPORT jint JNICALL Java_demo_bmp_1code_1init
	(JNIEnv *, jobject);

    JNIEXPORT void JNICALL Java_demo_bmp_1code_1free
	(JNIEnv *, jobject, jint);

    JNIEXPORT jstring JNICALL Java_demo_bmp_1code_1from_1file
	(JNIEnv *, jobject, jint, jstring);

    JNIEXPORT jstring JNICALL Java_demo_bmp_1code_1from_1buffer
...
demo_t demo(bmp_code_font *head, bmp_code_load *bmp, bmp_code_analysis *analysis)
{
...
(JNIEnv *env, jobject obj, jint bmp_obj, jstring path)
{
	...
	mydata[i] = demo(list_font, &bmp, &analysis);
    }
