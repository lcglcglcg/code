...
#define DEFAULT_MYSQL_HOME "/server/mysql-5.5.17"
#define SHAREDIR "/server/mysql-5.5.17/share"
#define DEFAULT_BASEDIR "/server/mysql-5.5.17"
#define MYSQL_DATADIR "/server/mysql-5.5.17/data"
#define DEFAULT_CHARSET_HOME "/server/mysql-5.5.17"
#define PLUGINDIR "/server/mysql-5.5.17/lib/plugin"
#define DEFAULT_SYSCONFDIR "/server/mysql-5.5.17/etc"
