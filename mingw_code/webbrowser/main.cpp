...
int main(int argc, char *argv[])
{
    ...
    MessageBoxW(0, L"查询(http://web.duowan.com/zhao/)页面(张国立或将主持马年春晚)的链接并播放", L"", MB_OK);
	...
	if ((pIHTMLDocument2 = webParent.GetIHTMLDocument2(webParent.m_pIWebBrowser2))) {
	    ...
	    if (ClickElementForeach(pIHTMLDocument2, (BSTR)L"张国立或将主持马年春晚") == TRUE)
		break;
	}
    }
    ...
    MessageBoxW(0, cookie, L"cookie信息", MB_OK);
