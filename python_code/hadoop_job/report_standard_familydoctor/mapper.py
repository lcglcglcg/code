...
def main():
        for line in sys.stdin:
                ...
                if visit_domain == 'familydoctor.com.cn' or visit_domain == 'familydoctor.com':
                        print chr(22).join((account_id, campaign_id, group_id, creative_id, bidding_model, display_style, click, cost))
