...
PHP_ADD_LIBRARY_WITH_PATH(m, $CODE_PARSE_DIR, CODE_PARSE_SHARED_LIBADD)
PHP_ADD_LIBRARY_WITH_PATH(gd, /usr/local/lib, CODE_PARSE_SHARED_LIBADD)
PHP_ADD_LIBRARY_WITH_PATH(jpeg, $CODE_PARSE_DIR, CODE_PARSE_SHARED_LIBADD)
PHP_SUBST(CODE_PARSE_SHARED_LIBADD)
